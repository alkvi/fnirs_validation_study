...
# Change group name
hypothesis_data$group <- paste("cbsi_", hypothesis_data$group, sep="")

# Here also read HbO, HHb, other data.
# HbO
csv_path <- "../Data/temp_data/hypothesis_table_hbo.csv"
hypothesis_data_hbo <- read.csv(csv_path)
hypothesis_data_hbo$group <- paste("hbo_", hypothesis_data_hbo$group, sep="")
...
hypothesis_data_hbr$group <- paste("hbr_", hypothesis_data_hbr$group, sep="")
...
hypothesis_data_hbt$group <- paste("hbt_", hypothesis_data_hbt$group, sep="")
...
hypothesis_data_hbd$group <- paste("hbd_", hypothesis_data_hbd$group, sep="")
...
hypothesis_data$group <- factor(hypothesis_data$group, levels=c('EX', 
                                                                'cbsi_YA', 'cbsi_OA', 'cbsi_PD',
                                                                'hbo_YA', 'hbo_OA', 'hbo_PD',
                                                                'hbr_YA', 'hbr_OA', 'hbr_PD',
                                                                'hbt_YA', 'hbt_OA', 'hbt_PD',
                                                                'hbd_YA', 'hbd_OA', 'hbd_PD'))
...
ya_data_cbsi = ya_data[ya_data$group %in% c("EX", "cbsi_YA"),]
oa_data_cbsi = oa_data[oa_data$group %in% c("EX", "cbsi_OA"),]
pd_data_cbsi = pd_data[pd_data$group %in% c("EX", "cbsi_PD"),]
...
p4 + p5 + p6
p_all <- p4 + p5 + p6
save_plot("ggplot_hypotheses_all.svg", fig = p_all, width=35, height=16)
